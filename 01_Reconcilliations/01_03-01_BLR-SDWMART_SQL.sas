...
/*05/03/2022 - Updated for Equity Correction*/
...
/*********************************************************************/
	...
	FROM 
			(
				...
				FROM 
					PRD.CM_ABS_MBS_CMO_INSTRMT
			) AS INSTR

			INNER JOIN PRD.CM_ABS_MBS_CMO_PSTN PSTN 
...
/*********************************************************************/
	...
	FROM 
			...
			INNER JOIN PRD.CM_BOND_PSTN PSTN 
...
FROM 
	(SELECT DISTINCT CASH_DEP_INSTRMT_VK, INVSTMT_TYP,AS_AT_MTH FROM PRD.CM_CASH_DEP_INSTRMT) AS INSTR, 
	PRD.CM_CASH_DEP_PSTN PSTN 
...
WHERE 
	...
	AND INVSTMT_TYP='004'  
	AND PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM  PRD.CM_CASH_DEP_PSTN) 
...
FROM 
	(SELECT DISTINCT REPO_INSTRMT_VK, INVSTMT_TYP,AS_AT_MTH FROM PRD.CM_REPO_INSTRMT) AS INSTRU, 
	PRD.CM_REPO_PSTN PSTN 
...
WHERE 
	...
	AND INVSTMT_TYP='004'  
	AND PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM  PRD.CM_REPO_PSTN)   
...
FROM 
	(SELECT DISTINCT MBS_CMO_INSTRMT_VK,INVSTMT_TYP,AS_AT_MTH FROM PRD.CM_ABS_MBS_CMO_INSTRMT) AS INSTR, 
	PRD.CM_ABS_MBS_CMO_PSTN PSTN 
...
WHERE 
	...
	AND INVSTMT_TYP='006'  
	AND PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM  PRD.CM_ABS_MBS_CMO_PSTN)   
...
FROM 
	(SELECT DISTINCT FUND_INSTRMT_VK,INVSTMT_TYP,AS_AT_MTH FROM PRD.CM_FUND_INSTRMT) AS INSTR, 
	PRD.CM_FUND_PSTN PSTN 
...
WHERE 
	...
	AND PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM  PRD.CM_FUND_PSTN)  
...
FROM 
	(SELECT DISTINCT DRVTS_INSTRMT_VK,INVSTMT_TYP,AS_AT_MTH FROM PRD.CM_DRVTS_INSTRMT) AS INSTR, 
	PRD.CM_DRVTS_PSTN PSTN 
...
WHERE 
	...
	AND PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM  PRD.CM_DRVTS_PSTN)  
...
FROM 
	PRD.CM_PRPTY_PSTN PSTN

WHERE 
	PSTN.AS_AT_MTH = &AS_AT_MTH 
	AND PSTN.PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM  PRD.CM_PRPTY_PSTN) 
...
FROM 
	...
	(SELECT DISTINCT LOAN_INSTRMT_VK,INVSTMT_TYP,AS_AT_MTH FROM PRD.CM_LOAN_INSTRMT) AS INSTR, 
	PRD.CM_LOAN_PSTN PSTN 
...
WHERE 
	...
	AND INVSTMT_TYP = '015' 
	AND PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM  PRD.CM_LOAN_PSTN) 
...
FROM 
	(SELECT DISTINCT CM_EQTY_INSTRMT_VK, INVSTMT_TYP,AS_AT_MTH FROM PRD.CM_EQTY_INSTRMT) AS INSTR, 
	PRD.CM_EQTY_PSTN PSTN 
...
WHERE 
	...
	AND INVSTMT_TYP='001'  
	AND PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM  PRD.CM_EQTY_PSTN) 
...
WHERE 
	AS_AT_MTH = &AS_AT_MTH 
	AND PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM  PRD.CM_INSTRMT)  
...
WHERE 
	AS_AT_MTH = &AS_AT_MTH  
	AND PPN_DTTM = (SELECT MAX(PPN_DTTM) FROM PRD.CM_INSTRMT_SMRY) 
